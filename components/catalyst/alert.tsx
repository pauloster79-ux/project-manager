...
export function Alert({
  ...
  return (
    <div className="fixed inset-0 z-50 flex w-screen justify-center overflow-y-auto bg-zinc-950/15 px-2 py-2 sm:px-6 sm:py-8 lg:px-8 lg:py-16 dark:bg-zinc-950/50">
